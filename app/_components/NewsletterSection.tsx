    ...
    <div className="bg-background mt-16">
      <Container className="py-12">
        <div data-section-item className="max-w-120 mx-auto text-center">
          {/* Notebook icon */}
          <div className="size-11 rounded-xl bg-muted border border-border mx-auto mb-6 center">
            <svg className="size-6" viewBox="0 0 17 17" fill="none">
              <rect
                x="2.5"
                y="1.5"
                width="10"
          ...
          <p className="font-bengali text-[0.75rem] text-muted-foreground mt-4">
