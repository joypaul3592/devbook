...
export const translations = {
  bn: {
    ...
    footer: {
      ...
      description:   "ওয়েব ডেভেলপমেন্ট, ডিজাইন সিস্টেম আর প্রতিদিনের কোডিং অভিজ্ঞতা নিয়ে লেখা একটি ব্যক্তিগত নোটবুক — যেখানে শেখা, তৈরি করা আর ভাবনাগুলো যত্ন করে সাজিয়ে রাখা হয়।",
      articles:     "লেখা",
      journal:      "জার্নাল",
      series:       "সিরিজ",
      projects:     "প্রজেক্ট",
      ...
      sectionContent: "কনটেন্ট",
      sectionMore:    "আরও",
      sectionConnect: "যোগাযোগ",
      contactUs:      "যোগাযোগ করুন",
      privacy:        "প্রাইভেসি পলিসি",
      terms:          "শর্তাবলী",
      sitemap:        "সাইটম্যাপ",
      available:      "নতুন কাজের জন্য উন্মুক্ত",
      backToTop:      "উপরে যান",
    },
    // Homepage
    home: {
    ...
    learn: {
      ...
      complete:     "সম্পন্ন",
      chaptersDone: "অধ্যায় শেষ",
      topicsDone:   "টপিক পড়া",
      written:      "লেখা হয়েছে",
      continueRead: "পড়া চালিয়ে যাও",
      startJourney: "যাত্রা শুরু করো",
      upNext:       "এরপর",
      rank:         "স্তর",
  ...
  en: {
    ...
    footer: {
      ...
      description:   "A personal notebook on web development, design systems, and the everyday craft of writing code — a quiet place where learning, building, and ideas are gathered with care.",
      articles:     "Articles",
      journal:      "Journal",
      series:       "Series",
      projects:     "Projects",
